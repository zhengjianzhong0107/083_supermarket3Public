		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑入库记录</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">入库记录管理</li>
								<li class="breadcrumb-item active">编辑入库记录</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">入库记录信息</h3>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("rukujilu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function crossTableUpdate(){
			...
			if(flag){
				httpJson(crossTableName + "/update","POST",{
					id: crossTableId,
																																																			kucunshuliang: Number(crossRuleForm.kucunshuliang) + Number($('#kucunshuliang').val()),
																										},(res)=>{
					if(res.code == 0){
						console.log('跨表更新成功');
						return true;
