...
<body>
		...
		<div id="content">
			...
			<div class="container mt-0">
				<div class="row breadcrumb-bar">
					<div class="col-md-6">
						<h3 class="block-title">注册用户信息管理</h3>
					</div>
					<div class="col-md-6">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">注册用户信息列表</li>
						</ol>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">注册用户信息列表</h3>
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
									<label> 用户名 <input type="text" id="usernameSearch"
										class="form-control form-control-sm" placeholder=""
										aria-controls="tableId">
									</label> <label> 姓名 <input type="text" id="nameSearch"
										class="form-control form-control-sm" placeholder=""
										aria-controls="tableId">
									</label> <label> 性别 <select name="sex" id="sexSelect"
									...
									<thead>
										<tr>
											...
											<th onclick="sort('sex')">性别<i id="sexIcon"
												class="fa fa-sort"></i></th>
											<th onclick="sort('phone')">手机<i id="phoneIcon"
												class="fa fa-sort"></i></th>
											<th onclick="sort('email')">邮箱<i id="emailIcon"
												class="fa fa-sort"></i></th>

											<th>照片</th>
											<th onclick="sort('age')">年龄<i
												id="ageIcon" class="fa fa-sort"></i></th>
	...
	<%@ include file="../../static/crossBtnControl.js"%>
		...
		function search() {
			...
			var sexIndex = document.getElementById("sexSelect").selectedIndex;
			var sexOptions = document.getElementById("sexSelect").options;
			var sexSelectedOption = sexOptions[sexIndex]
			if (sexSelectedOption.text != null
					&& sexSelectedOption.text != '') {
				searchForm.sex = "%" + sexSelectedOption.text + "%";
			}
			getDataList();
		}
		// 获取数据列表
