							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="type" name="type" class="form-control" placeholder="支付类型（1：现金 2：积分）">
									</div>
											<div class="form-group col-md-6">
										<label>状态</label>
										<input id="status" name="status" class="form-control" placeholder="状态">
									</div>
											<div class="form-group col-md-6">
										<label>地址</label>
