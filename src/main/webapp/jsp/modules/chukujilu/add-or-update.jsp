		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑出库记录</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">出库记录管理</li>
								<li class="breadcrumb-item active">编辑出库记录</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">出库记录信息</h3>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("chukujilu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chukujilu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
					...
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.kucunshuliang != null && res.data.kucunshuliang != ''){
															...
															kucunshuliangKucun = res.data.kucunshuliang;
		...
		function crossTableUpdate(){
			...
			if(flag){
				httpJson(crossTableName + "/update","POST",{
					id: crossTableId,
																																																			kucunshuliang: crossRuleForm.kucunshuliang - $('#kucunshuliang').val(),	
																										},(res)=>{
					if(res.code == 0){
						console.log('跨表更新成功');
						return true;
		...
		function crossTableUpdateValidation(){
			//防止减法导致库存负值
																																	if(kucunshuliangKucun < $('#kucunshuliang').val()){
						alert('库存数量不能大于'+kucunshuliangKucun+'！请重新输入');
						return false;
					}
																	return true;
		}
